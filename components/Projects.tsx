...
export default function Projects() {
  ...
  return (
    <section id="projects" className="section py-10 md:py-20" ref={containerRef}>
      ...
      {/* Responsive Section Title */}
<div className="project-title px-2 md:px-0 mb-6 md:mb-10 mt-4 md:mt-6">
  <p className="uppercase text-xs md:text-sm font-bold tracking-widest text-neutral-500 text">
    Recent Projects
  </p>
  <h2 className="text-2xl sm:text-4xl md:text-5xl lg:text-6xl font-medium max-w-full lg:max-w-4xl mt-1 text leading-tight">
          ...
          {projectItems.map((item, index) => (
            ...
            >
              <div className="flex justify-between  items-center">
                {/* Project Title */}
                <h3
                  className="text-xl sm:text-3xl text-blue-300 md:text-4xl uppercase font-medium text group-hover:translate-x-2 transition-transform duration-300 cursor-pointer"
                ...
                {/* Details Button */}
                <button
                  className="px-3 py-1 md:px-4 md:py-0 rounded-full border text-sm md:text-base  hover:bg-blue-100 transition"
                  onClick={(e) => {
